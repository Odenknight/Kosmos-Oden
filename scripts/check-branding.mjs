...
if (failures.length) {
  console.error("check-branding: visible Kosmos-Oden copy must use GKX; OKF+ is permitted only in explicit compatibility or historical context");
  console.error(failures.join("\n"));
  process.exit(1);
}
console.log("check-branding: OK — visible Kosmos-Oden copy uses GKX with bounded legacy compatibility references");

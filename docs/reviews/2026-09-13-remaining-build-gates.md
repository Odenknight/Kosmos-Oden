...
| W1–W4 workspace | Search, preview, origin records, effective header, source details, lineage, map, drawers and readable selection return are implemented with browser coverage. | Structured inspector tabs/evidence, unresolved-reference treatment, stable UID selection and complete accepted fixture matrix; native view/edit/return/layout/performance qualification. |

...
**Branch:** `renderer/three-r185-webgl` · **Status:** RC groundwork, not yet promoted.

This branch executes **Phase 1** of the renderer program in
`docs/assessments/Kosmos-Oden-Engineering-Review/`: move the stable renderer

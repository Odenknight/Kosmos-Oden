...
Kosmos-Oden is the active Obsidian-plugin continuation of Kosmos-Oden-Lite. It
consumes GKOS-Engine and operates on the current GKX 2.3 line. It is built on
a fork and rebuild of [H4R7W16/vault-kosmos](https://github.com/H4R7W16/vault-kosmos).
...
Notes written in **GKX** (Open Knowledge Format Plus) light up temporal features natively:

...
import { GKX23_POLICY, GKX23_PROFILE } from "gkos-engine";
...
export class KosmosAgentServer {
  ...
  private brief(n: GkxNode, graph?: GkxGraph, visible?: Set<string>, byId?: Map<string, GkxNode>): any {
    ...
    return {
      ...
      sensitivity: n.gkx?.projection?.effective.sensitivity ?? n.gkx?.sensitivity ?? "internal",
  ...
  async qOverview(): Promise<any> {
    ...
    return {
      ...
      gkxProfile: "GKX v2.3 Validating Projection Profile (not full GKOS; no governed writer)",
  ...
  toolDefs(): any[] {
    ...
    return [
      ...
      tool("get_gkx_note", "Get GKX note projection", "Origin-separated authored, derived, proposed, approved, and effective GKX v2.3 projection.", selectionSchema),

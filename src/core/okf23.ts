...
export function projectOkf23(data: Frontmatter, rawContent: string, sourcePath = "", mode: Okf23Projection["mode"] = "compatible", engineVersion = "0.6.5-beta.8"): Okf23Projection {
